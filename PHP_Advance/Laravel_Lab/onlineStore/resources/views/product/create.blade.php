...
<head>
    ...
    <style> 
        body { font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 50px; }                                                                                                                     
           .form-container { background: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); max-width: 500px; margin: 0 auto; }                                                      
    ...
    <div class="form-container">
        ...
        @if (session('success'))
            <div class="alert-success">
                ...
                <br>
                <img src="{{asset('storage/' . session('image_path') )}}" alt="Ảnh SP" style="max-width: 100px; margin-top: 10px; border-radius: 4px;" >
            </div>
        @endif
        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" name="product_price" required placeholder="VD: 150000...">
            </div>
            <div class="form-group">
